$(window).load(function () {
    $("#rotator").rotator({
        ...
        callback: function () {
            $('#loadPage').fadeOut(1000, 0, function () {
...
(function ($) {
    $.fn.rotator = function(options){
        ...
        this.empty().append("<canvas height ="+this.height() + " width="+this.width()+" id='canvasRotator'/ ></canvas>");
        var canvas = document.getElementById('canvasRotator');
